...
private void _LaneMove()
    ...
    private void _Window(Sprite _planetSprite, TextMeshProUGUI _planetText)
    {
        ...
        _playerPowerText.text = $"攻撃力:{_playerStatas._power}(Lv:{_playerStatas._powerLevel})";
        _playerCoolTimeText.text = $"Cタイム:{_playerStatas._coolTime}秒(Lv:{_playerStatas._coolTimeLevel})";
        _playerHpText.text = $"体力:{_playerStatas._hp} (Lv: {_playerStatas._hpLevel})";
